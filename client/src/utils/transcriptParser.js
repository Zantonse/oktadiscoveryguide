...
const SELLER_SIGNALS = {
  ...
  solutionLanguage: {
    weight: 2,
    patterns: [/let me explain/i, /our solution/i, /okta can/i, /we can help/i, /i'd recommend/i],
  },
  meetingOpener: {
    weight: 1,
    patterns: [
      /thanks for your time/i,
      /i appreciate you meeting/i,
      /thanks for taking/i,
      /good to connect/i,
    ],
  },
  followUp: {
    weight: 1,
    patterns: [/can you tell me more/i, /how does that/i, /what about/i, /could you elaborate/i],
  },
}
...
const PROSPECT_SIGNALS = {
  ...
  roleIntro: {
    weight: 1,
    patterns: [/i'm the/i, /i manage/i, /i oversee/i, /i'm responsible for/i, /my team handles/i],
  },
