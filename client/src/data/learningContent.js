    ...
    aiAgents: {
      ...
      areas: [
        ...
        // New discovery areas based on Robinhood transcript analysis
        {
          ...
          technicalContext: {
            idJag: {
              ...
              description:
                'Short-lived, one-time token for AI agent token exchange via Cross App Access (XAA)',
        ...
        },
        {
          ...
          technicalContext: {
            workloadPrinciple:
              'Each agent has its own identity (client_id in tokens) - the Workload Principle',
            managedConnections:
              'IT admin defines which resources each agent can access via Managed Connections',
            resourceTypes: [
              'Authorization server (OAuth scopes)',
              'Secret (API keys)',
        ...
        },
        {
          ...
          technicalContext: {
            ...
            solution:
              'Use XAA to control what resources agents can access, regardless of MCP server',
