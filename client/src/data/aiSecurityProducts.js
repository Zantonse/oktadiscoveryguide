...
export const aiSecurityProducts = [
  {
    ...
    description:
      'OAuth/OIDC authentication for generative AI applications. Enables secure user access to AI tools with SSO, MFA, and lifecycle management.',
    painPoints: [
  ...
  },
  {
    ...
    description:
      'Secure storage for user API tokens that AI agents need to access on behalf of users. Prevents credential exposure and enables token lifecycle management.',
    painPoints: [
      'credential sprawl',
      'API keys in code',
      'secrets management',
  ...
  },
  {
    ...
    description:
      'OAuth 2.0 machine identity management for autonomous AI agents. Enables secure agent-to-service authentication with policy-based authorization.',
    painPoints: [
  ...
  },
  {
    ...
    description:
      'Secure agent-to-app and app-to-app access delegation using OAuth extensions. Enables agents to act across multiple enterprise systems on behalf of users.',
    painPoints: [
  ...
  },
  {
    ...
    description:
      'Identity Security Posture Management for AI workloads. Discovers shadow AI, monitors OAuth grants, and provides visibility into AI agent permissions.',
    painPoints: [
      'shadow AI',
  ...
  },
  {
    ...
    description:
      'Security for Model Context Protocol (MCP) agent-tool connections. Provides authentication, scoped permissions, and audit logging for agent tool access.',
    painPoints: [
      'MCP tools',
      'agent tool access',
