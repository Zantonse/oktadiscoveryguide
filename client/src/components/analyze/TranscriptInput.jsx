      ...
      {inputTab === 'upload' && (
        ...
        >
          ...
          <div className="upload-content">
            ...
            <p className="upload-primary">Drop your transcript file here</p>
            <p className="upload-secondary">
              or <button onClick={() => fileInputRef.current?.click()}>browse files</button>
            </p>
            <p className="upload-formats">Supports TXT, JSON, VTT</p>
          </div>
        </div>
      )}

      {/* Submit button */}
      <button className="analyze-submit-btn" onClick={handleSubmit} disabled={!isValid}>
        <svg
          width="20"
          height="20"
          viewBox="0 0 24 24"
