...
export function ScenarioSelector() {
  const { selectedScenario, setSelectedScenario, availableScenarios, conversationStarted } =
    useSession()
    ...
    <Card title="Scenario (Optional)" className="selector-card scenario-card">
      ...
      {!selectedScenario && (
        <p className="scenario-hint">
          Scenarios add situational context like "dealing with audit findings" or "AI cautious
          organization"
        </p>
      )}
    </Card>
