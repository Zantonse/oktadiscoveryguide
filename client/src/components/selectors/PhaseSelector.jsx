...
const tracks = {
  sales: {
    ...
    description:
      'Practice uncovering business pain, budget, and decision process for Identity Governance',
    icon: 'briefcase',
  },
  technical: {
    id: 'technical',
  ...
  aiAgents: {
    ...
    description:
      'Discover customer needs for Okta AI security, agent authentication, and agentic AI',
    icon: 'bot',
  },
}

export function PhaseSelector() {
  const { selectedTrack, setSelectedTrack, conversationStarted } = useSession()
