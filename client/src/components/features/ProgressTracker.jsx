...
export function ProgressTracker() {
  const { messages, selectedTrack, selectedPhase, completedPhases } = useSession()
  ...
  const insightMessages = messages.filter(
    (m) => m.role === 'assistant' && keyTerms.some((term) => m.content.toLowerCase().includes(term))
  )
